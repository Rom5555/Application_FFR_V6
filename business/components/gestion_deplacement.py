...
class Gestion_deplacement(Ifonction_get,Ifonction_create, Ifonction_update):
    ...
    def create(self):
        ...
        self._data_deplacement.create_deplacement(self.deplacement.nombre_joueur,self.deplacement.duree_deplacement,self.deplacement.nombre_match)

    def update(self):
        self._data_deplacement.update_deplacement(self.deplacement.nombre_joueur,self.deplacement.duree_deplacement,self.deplacement.nombre_match)

    def get_id(self):

        row = self._data_deplacement.get_1_deplacement(self.deplacement.nombre_joueur,self.deplacement.duree_deplacement,self.deplacement.nombre_match)
        print(row)
        return row[0]

    def get_1(self):
        row = self._data_deplacement.get_1_deplacement(self.deplacement.nombre_joueur,
